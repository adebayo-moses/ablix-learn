...
<template>
  <main>
    <div class="bg-gradient-to-b from-[#101212] relative to-[#08201D]">
      <header class="absolute inset-x-0 top-0 z-10 w-full">
        <div class="px-4 mx-auto sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div
              class="lg:flex lg:items-center lg:justify-end lg:space-x-6 sm:ml-auto"
            >
              <a
                href="#"
                title=""
      ...
      <section
        class="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24"
      >
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
          <div class="max-w-xl mx-auto text-center">
            ...
            <p class="mt-5 text-base text-white sm:text-xl">
              No more hassle with learning about Tech. from the tiniest to the
              largest bit, we've got you covered.
            </p>
            ...
            >
              ...
              <div class="flex items-center">
                ...
                <p class="ml-3 text-sm text-white">
                  No crazy timetables, learn at your pace.
                </p>
              </div>
              ...
              <div class="flex items-center">
                ...
                <p class="ml-3 text-sm text-white">Secured & safe community.</p>
              </div>
            </div>
          </div>
        </div>
